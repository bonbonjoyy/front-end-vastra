...
function Military() {
  ...
  useEffect(() => {
    ...
    const fetchGaleri = async () => {
      try {
        const response = await fetch('https://back-end-vastra.vercel.app/galeris/kategori/Khusus/subCategory/Military');
      ...
      {selectedImage && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white p-4 w-full max-w-sm max-h-[90vh] h-auto overflow-auto relative">
            ...
            <img src={selectedImage} alt="Selected Military Outfit" className="w-full mb-4 max-w-full" />
